  ...
  const [exceptions, setExceptions] = useState([
    {
      ...
      client: "Arla",
      severity: "high",
      description: "Expected £150/hr, found £125/hr for Senior Consultant",
      action: "Update rate in Harvest",
    },
    {
      id: 2,
      type: "Budget Breach",
      client: "Sainsburys",
      severity: "medium",
      description: "Project at 92% budget utilization",
      action: "Review with PM",
    },
    {
      id: 3,
      ...
      client: "ADM",
      severity: "high",
      description: "Data ingestion marked as billable",
      action: "Reclassify as exclusion",
    },
  ]);
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSyncError({
          ...
          message:
            errorData.message || `Failed to sync ${source}. Please try again.`,
        });
      }
    } catch (error) {
      setSyncError({
      ...
      <Flex justify="between" align="center" className="mb-8">
        <Box>
          ...
          <Text size="3" color="gray">
            Profitability & Billing Dashboard
          </Text>
        </Box>
        <Flex gap="3">
          <Button
          ...
          >
            <RefreshCw
              className={`w-4 h-4 mr-2 ${syncing === "harvest" ? "animate-spin" : ""}`}
            />
          ...
          >
            <Activity
              className={`w-4 h-4 mr-2 ${syncing === "hubspot" ? "animate-pulse" : ""}`}
            />
          ...
          >
            <TrendingUp
              className={`w-4 h-4 mr-2 ${syncing === "sft" ? "animate-pulse" : ""}`}
            />
          ...
          <Tabs.Content value="profitability">
            <Card size="3">
              <Heading size="4" className="mb-4">
                Profitability Trend - {selectedClient}
              </Heading>
                    ...
                    <Flex justify="between" align="start">
                      <Box className="flex-1">
                        <Flex gap="2" align="center" className="mb-2">
                          <Badge
                            color={
                              exception.severity === "high" ? "red" : "orange"
                            }
                          >
